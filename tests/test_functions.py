...
class TestFunctions(unittest.TestCase):
    ...
    def test_rosenbrock_2d_asgd(self):
        lr = 3.5e-4
        err, history = test_rosenbrock(dim=2, optimizer='asgd', lr=lr, epochs=60000, initial_guess=[-3,-4])
    ...
    def test_rosenbrock_2d_sgd_anderson(self):
        lr = 1.e-4
        err, history = test_rosenbrock_anderson(dim=2, optimizer='sgd', lr=lr, epochs=20000, initial_guess=[-3,-4])
    ...
    def test_rosenbrock_2d_rmsprop_anderson(self):
        lr = 5.e-4
        err, history = test_rosenbrock_anderson(dim=2, optimizer='rmsprop', lr=lr, epochs=20000, initial_guess=[-3,-4])
    ...
    def test_rosenbrock_2d_adam_anderson(self):
        lr = 1.e-1
        err, history = test_rosenbrock_anderson(dim=2, optimizer='adam', lr=lr, epochs=20000, initial_guess=[-3,-4])
    ...
    def test_rosenbrock_2d_asgd_anderson(self):
        lr = 3.5e-4
        err, history = test_rosenbrock_anderson(dim=2, optimizer='asgd', lr=lr, epochs=60000, initial_guess=[-3,-4])
